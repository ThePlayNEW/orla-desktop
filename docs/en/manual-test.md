...
- [ ] **14. New panel and quit.** Under **Panels**, click **New panel** and create **Pictures**: it appears on the desktop without covering another panel. Finally, right-click the Orla icon in the notification area and choose **Quit and restore the desktop**. The panels disappear and the Windows icons are as they were before the test.
