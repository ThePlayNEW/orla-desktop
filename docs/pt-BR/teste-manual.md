...
- [ ] **14. Novo painel e sair.** Em **Painéis**, clique em **Novo painel** e crie **Imagens**: ele aparece no desktop sem cobrir outro painel. Por fim, clique com o botão direito no ícone do Orla na bandeja e escolha **Sair e restaurar o desktop**. Os painéis somem e os ícones do Windows estão como antes do teste.
