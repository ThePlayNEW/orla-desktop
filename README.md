...
| [`OrlaDesktop-win-Portable.zip`](https://github.com/ThePlayNEW/orla-desktop/releases/latest/download/OrlaDesktop-win-Portable.zip) | Quem prefere não instalar. Extraia numa pasta sua, como Documentos, e abra `Orla Desktop.exe`. Também se atualiza sozinho. |
...
O único acesso à rede é a busca por atualizações das versões instalada e portátil: a cada poucas horas, o Orla pede ao GitHub a lista de versões deste repositório, sem enviar dados pessoais. Você pode desligar em **Sobre > Atualizações automáticas**. Links como **Guia de uso** e **Relatar um problema** abrem no seu navegador só quando você clica.
