...
- **Report a bug.** Use the [bug form](https://github.com/ThePlayNEW/orla-desktop/issues/new/choose). Include your Windows version, Orla version, wallpaper program and monitor setup.
...
- **Relate um problema** pelo [formulário](https://github.com/ThePlayNEW/orla-desktop/issues/new/choose), com a versão do Windows e do Orla, o programa de papel de parede e os monitores.
